...
//Question - 3
function myTwoNumberAddition(){
    var firstNumber = +prompt("Enter First Number");
    var secoondNumber = +prompt("Enter Second Number");
    var result = firstNumber+secoondNumber;
...
//Question - 5
function mySqureAnumber(a){
    r=a*a;
    return r;
}
var x=3;
var z = mySqureAnumber(x);
document.write("Saquare of the "+x+" is "+z);

//Question - 6
function myFactorial(f){
Number=f;
result=1;
for (a=1;a<=f; a++){
    result=result*a;
...
//Question - 7
function myCounting(){
    a=+prompt("Starting Number");
    b=+prompt("Ending Number")
    for (i=a; i<=b; i++){
        document.write(i+"<br>");
    }
}
...
//Question - 8
function myHypotenues(a,b,h=0){
    h=innerCalculation(a,b);
hypotenues=Math.pow(h,0.5);
return hypotenues;
    function innerCalculation(b, p){
        result=0;
        p=Math.pow(p,2);
        b=Math.pow(b,2);
        result=p+b;
...
z=myHypotenues(3,4,0);
alert("Hypotenues is : "+z);
...
// i) Argument as value
result = areaOfrectangle(3,4);
alert(result);
// ii) Arugument as varibale
a=6;
b=4;
result = areaOfrectangle(a,b);
alert(result);
...
for (i=wordLength; i>=1; i--){
    reversWord =word[i-1]; 
    palindromWord = palindromWord.concat(reversWord);
}
if (lword===palindromWord.toLowerCase()){
    alert(word+" is a palindrome word")
}
else {
    alert(word+" is a not palindrome word");
}
}
palindromCheck("Racecar")

//Question - 11
function titleCase(a){
    var string = a;
    var string=string.toLowerCase();
    var string=string.slice(0,1).toUpperCase()+string.slice(1);
    var numCharString = string.length;
    for (i=0; i<numCharString; i++){
          if(string.slice(i,i+1)===" "){
              string=string.slice(0,i)+string.slice(i,i+2).toUpperCase()+string.slice(i+2);
          }
      }
      alert(string);
    }
...
var largestWord="";
for (a=0;a<=string2Length-1;a++){
    if (largestWord.length < string2[a].length)
    {
        largestWord=string2[a];
    }
}
document.write("Largest Word in the String is : "+largestWord);
}
largestWord("Web Development Tutorial");

//Question - 13
function occurrencOfLetter(a,b){
var letter = a;
var string=b;
...
alert(letter+" occured "+occurence+" times in the string "+string);
}
occurrencOfLetter("o","JSResourceS.com");

//Question - 14

function calcCircumference(radius){
var r=radius;
var pie=3.141592653589793238;
var circumference = 0;
